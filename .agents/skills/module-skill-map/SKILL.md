...
| `market_health` | SERVICE | `clean-architecture`, `operational-purpose` | `market-health-intelligence` | 6D convergence score + F&G contrarian layer — consumed by entry gates, CIO |
