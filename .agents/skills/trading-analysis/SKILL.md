...
This skill generates comprehensive investment reports combining real-time market data, technical analysis, AI-powered insights, and professional visualizations.
...
- Analyzes market conditions using AI agent capabilities
...
- **AI Model**: AI agent performing the analysis (model-agnostic)
...
- Requires an AI agent with tool access for data fetching
