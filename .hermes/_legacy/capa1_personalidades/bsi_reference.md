...
|:---:|:---|:---:|:---:|:---:|:---:|:---|:---|
| 0 | `BREADTH_WASHED_OUT` | 239 | 54.0% | +0.1% | +0.28% | **Amplitud Destruida / 93.3% Rango de Suelo** | `Piso / Capitulación de Amplitud` |
| 1 | `OVERSOLD_BREADTH` | 990 | 56.8% | +2.9% | +0.46% | **Rebote de Amplitud en Expansión (+2.9% Edge)** | `Acumulación / Ensanchamiento` |
| 2 | `NEUTRAL_LOW_BREADTH` | 1897 | 52.0% | -1.9% | +0.22% | **Amplitud Media-Baja** | `Participación Selectiva` |
| 3 | `NEUTRAL_HIGH_BREADTH` | 1880 | 53.0% | -0.9% | +0.32% | **Amplitud Saludable** | `Mercado Amplio` |
| 4 | `EXPANSIVE_BREADTH` | 1051 | 53.3% | -0.6% | +0.30% | **Amplitud Fuerte** | `Impulso de Participación` |
| 5 | `HYPER_EXPANSIVE_BREADTH` | 264 | 54.2% | +0.3% | +0.33% | **Breadth Thrust / Impulso Masivo** | `Empuje Extremo de Amplitud` |
...
- **Doble Naturaleza Operativa (Riesgo vs Oportunidad Generacional):**
  * **Fase de Impacto Cinético Inicial (Caída libre / D2 expansivo):** bloqueo por crisis — si D2 es FAST_CRUSH_3D con liquidación masiva.
  * **Fase de Clímax, Capitulación o Absorción:** **LA GRAN OPORTUNIDAD DE COMPRA GENERACIONAL** → compra táctica — en cuanto BSI comience a cruzar al alza desde < 10%.
...
|:---:|:---|:---|:---|:---:|:---:|:---:|:---:|
| `0__0__3` | `BREADTH_WASHED_OUT` | `FAST_CRUSH_3D` | `VOL_ACCELERATING_EXPANSION` | +46.1% | 100.0% | 1.7 | 5 | [56.6%, 100.0%] |
| `3__4__4` | `NEUTRAL_HIGH_BREADTH` | `FAST_SPIKE_3D` | `VOL_PEAK_DECELERATION` | +46.1% | 100.0% | 4.12 | 2 | [34.2%, 100.0%] |
| `5__4__3` | `HYPER_EXPANSIVE_BREADTH` | `FAST_SPIKE_3D` | `VOL_ACCELERATING_EXPANSION` | +46.1% | 100.0% | 2.95 | 2 | [34.2%, 100.0%] |
| `3__1__4` | `NEUTRAL_HIGH_BREADTH` | `DECELERATING_DOWN_3D` | `VOL_PEAK_DECELERATION` | +30.7% | 84.6% | 3.06 | 13 | [57.8%, 95.7%] |
| `0__2__4` | `BREADTH_WASHED_OUT` | `STABLE_CONTINUATION_3D` | `VOL_PEAK_DECELERATION` | +21.1% | 75.0% | 1.57 | 4 | [30.1%, 95.4%] |
...
|:---:|:---|:---|:---|:---:|:---:|:---:|:---:|
| `1__4__2` | `OVERSOLD_BREADTH` | `FAST_SPIKE_3D` | `VOL_NEUTRAL_BASELINE` | -53.9% | 0.0% | 0.67 | 2 | [0.0%, 65.8%] |
| `5__4__0` | `HYPER_EXPANSIVE_BREADTH` | `FAST_SPIKE_3D` | `VOL_EXTREME_SQUEEZE` | -53.9% | 0.0% | 0.47 | 2 | [0.0%, 65.8%] |
| `5__4__1` | `HYPER_EXPANSIVE_BREADTH` | `FAST_SPIKE_3D` | `VOL_MODERATE_COMPRESSION` | -53.9% | 0.0% | 0.49 | 5 | [0.0%, 43.4%] |
| `5__3__3` | `HYPER_EXPANSIVE_BREADTH` | `ACCELERATING_UP_3D` | `VOL_ACCELERATING_EXPANSION` | -33.9% | 20.0% | 0.62 | 5 | [3.6%, 62.4%] |
| `2__4__4` | `NEUTRAL_LOW_BREADTH` | `FAST_SPIKE_3D` | `VOL_PEAK_DECELERATION` | -28.9% | 25.0% | 0.55 | 4 | [4.6%, 69.9%] |
