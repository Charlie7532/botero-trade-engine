...
|---|---|---|:---:|
| **VIX** | `DEEP_COMPLACENCY, LOW_VOL, MODERATE_VOL, HIGH_VOL, ELEVATED_PANIC, CRISIS_SPIKE` | Idéntico | ✅ |
...
| **Credit** | `CREDIT_CRISIS, CREDIT_STRESS, STABLE_CREDIT, ELEVATED_CREDIT, CREDIT_EASING, CREDIT_EUPHORIA` | `CREDIT_CRISIS, CREDIT_STRESS, ELEVATED_CREDIT_STRESS, STABLE_CREDIT, CREDIT_EASE, DEEP_CREDIT_EASE` | ❌ **4/6 distintos** |
| **Rotation** | `DEFENSIVE_CAPITULATION, DEFENSIVE, NEUTRAL_ROTATION, MODERATE_RISK_ON, AGGRESSIVE_RISK_ON, EXTREME_RISK_ON` | `DEFENSIVE_CAPITULATION, DEFENSIVE, NEUTRAL_ROTATION, BALANCED, CYCLICAL_LEADERSHIP, AGGRESSIVE_ROTATION` | ❌ **3/6 distintos** |
| **PCR** | `EXTREME_CALL_DOMINANCE, LOW_PCR, NEUTRAL_PCR, ELEVATED_PCR, HIGH_PCR, EXTREME_PUT_PANIC` | `EXTREME_CALL_HEAVY, BULLISH_PCR, NEUTRAL_PCR, ELEVATED_PCR, HIGH_PUT_PANIC, EXTREME_PUT_PANIC` | ❌ **3/6 distintos** |
| **VVIX** | `EXTREME_COMPLACENCY, LOW_VVIX, MODERATE_VVIX, HIGH_VVIX, ELEVATED_VVIX, EXTREME_VVIX` | Idéntico | ✅ |
| **SV5 Turb** | `LOW_TURBULENCE, MODERATE_LOW, MODERATE_TURBULENCE, HIGH_TURBULENCE, ELEVATED_TURBULENCE, EXTREME_TURBULENCE` | `QUIET_FLOW, LOW_TURBULENCE, MODERATE_TURBULENCE, HIGH_TURBULENCE, ELEVATED_TURBULENCE, CRISIS_TURBULENCE` | ❌ **3/6 distintos** |
| **SKEW** | `LOW_TAIL_RISK, MODERATE_TAIL, NEUTRAL_TAIL, ELEVATED_TAIL_RISK, TAIL_PARANOIA, BLACK_SWAN_PARANOIA` | `LOW_TAIL_RISK, NORMAL_TAIL_RISK, ELEVATED_TAIL_RISK, HIGH_TAIL_RISK, TAIL_PARANOIA, BLACK_SWAN_PARANOIA` | ❌ **3/6 distintos** |
...
| **DXY** | `DEEP_DOLLAR_CRUSH, LOW_DOLLAR, MODERATE_LOW_DOLLAR, MODERATE_HIGH_DOLLAR, ELEVATED_DOLLAR_STRESS, DOLLAR_SPIKE_CRISIS` | `DEEP_DOLLAR_CRUSH, WEAK_DOLLAR, MODERATE_LOW_DOLLAR, MODERATE_HIGH_DOLLAR, ELEVATED_DOLLAR_STRESS, DOLLAR_SPIKE_CRISIS` | ❌ **1/6 distinto** |
