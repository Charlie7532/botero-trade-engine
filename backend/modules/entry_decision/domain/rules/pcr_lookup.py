...
class PCRLookupAdapter:
    def __init__(self):
        ...
        self.labels_d1 = doc.get("dimension_thresholds_definition", {}).get("pcr_labels_d1", ['EXTREME_CALL_HEAVY', 'BULLISH_PCR', 'NEUTRAL_PCR', 'ELEVATED_PCR', 'HIGH_PUT_PANIC', 'EXTREME_PUT_PANIC'])
