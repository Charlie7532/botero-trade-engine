...
class PCRLookupAdapter:
    def __init__(self):
        ...
        self.edges_d1 = doc.get("dimension_thresholds_definition", {}).get("pcr_edges_d1", [0.6909342628, 0.7996458092000001, 0.922, 1.084, 1.3126544183999993])
        self.edges_d2 = doc.get("dimension_thresholds_definition", {}).get("pcr_edges_d2", [-0.35011423199999997, -0.14899999999999994, 0.150476452, 0.34756691199999973])
        self.edges_d3 = doc.get("dimension_thresholds_definition", {}).get("pcr_edges_d3", [0.2658545129101965, 0.5215467493815035, 1.1898278647955016, 1.5179049213894475])
        self.labels_d1 = doc.get("dimension_thresholds_definition", {}).get("pcr_labels_d1", ['EXTREME_CALL_EUPHORIA', 'CALL_EUPHORIA', 'NEUTRAL_CALL_BIAS', 'NEUTRAL_PUT_BIAS', 'PUT_PANIC', 'EXTREME_PUT_PANIC'])
        self.labels_d2 = doc.get("dimension_thresholds_definition", {}).get("pcr_labels_d2", ['FAST_CRUSH_3D', 'DECELERATING_DOWN_3D', 'STABLE_CONTINUATION_3D', 'ACCELERATING_UP_3D', 'FAST_SPIKE_3D'])
        self.labels_d3 = doc.get("dimension_thresholds_definition", {}).get("pcr_labels_d3", ['VOL_EXTREME_SQUEEZE', 'VOL_MODERATE_COMPRESSION', 'VOL_NEUTRAL_BASELINE', 'VOL_ACCELERATING_EXPANSION', 'VOL_PEAK_DECELERATION'])
    ...
    def lookup_pcr_guidance(
        ...
        **kwargs
        ...
        return PCRStateGuidance(
            ...
            timing=get_timing_context("pcr", matched_key),
