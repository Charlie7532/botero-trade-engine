...
class RotationLookupAdapter:
    def __init__(self):
        ...
        self.edges_d1 = thresh.get("d1_edges_gauss_sigma", thresh.get("rotation_edges_d1", [-4.31, -1.98, 0.72, 2.97, 4.65]))
        self.edges_d2 = thresh.get("d2_edges_gauss_sigma", thresh.get("rotation_edges_d2", [-2.88, -0.73, 0.78, 2.95]))
        self.edges_d3 = thresh.get("d3_vol_edges_gauss_sigma", thresh.get("rotation_edges_d3", [0.03, 0.12, 0.81, 1.25]))
        self.labels_d1 = ['EXTREME_DEFENSIVE', 'DEFENSIVE', 'NEUTRAL_DEFENSIVE', 'NEUTRAL_OFFENSIVE', 'OFFENSIVE', 'EXTREME_OFFENSIVE']
    ...
    def lookup_rotation_guidance(
        ...
        vol_d3: float = 0.0,
        **kwargs
    ) -> Optional[RotationStateGuidance]:
        if val is None:
        ...
        d1_depth, f1 = validate_overflow("rotation", "d1", val)
        d2_depth, f2 = validate_overflow("rotation", "d2", d3_speed)
        d3_depth, f3 = validate_overflow("rotation", "d3", vol_norm)
        ...
        return RotationStateGuidance(
            ...
            timing=get_timing_context("rotation", matched_key),
