...
class SV5TurbulenceLookupAdapter:
    ...
    def lookup_sv5_turbulence_guidance(
        ...
        **kwargs
        ...
        d1_depth, f1 = validate_overflow("sv5_turbulence", "d1", val)
        d2_depth, f2 = validate_overflow("sv5_turbulence", "d2", d3_speed)
        d3_depth, f3 = validate_overflow("sv5_turbulence", "d3", vol_norm)
        ...
        return SV5TurbulenceStateGuidance(
            ...
            timing=get_timing_context("sv5_turbulence", matched_key),
