...
==================================================================================
Generates authoritative, zero-fallback PCR Market METARs.
...
class MarketMETAR:
    ...
    def format_cli_broadcast(self) -> str:
        ...
        return (
            "================================================================================\n"
            f" 📢 MARKET METAR — CBOE EQUITY PUT/CALL RATIO (PCR) [{self.metar_id}]\n"
            "================================================================================\n"
...
def get_pcr_market_metar(as_of_date: Optional[str] = None) -> MarketMETAR:
    """
    Generates an authoritative PCR Market METAR on-demand using 3-day fast velocity.
    ...
    try:
        ...
        if as_of_date:
            ...
            if len(df_pcr) < 4:
                raise StrictDataPolicyError(
                    f"⚠️ METAR NOT AVAILABLE: Insufficient historical CBOE_PCR bars in Neon Vault "
        ...
        metar_id = f"METAR-PCR-{clean_date}-001"
