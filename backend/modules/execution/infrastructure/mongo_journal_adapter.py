"""
Execution — MongoDB Trade Journal Adapter
=============================================
Infrastructure adapter: all MongoDB operations live HERE.
...
class MongoTradeJournalAdapter(TradeJournalPort):
    ...
    def __init__(
        ...
        Args:
            ...
            db: Pre-built pymongo Database instance (for tests with mongomock).
        """
        if db is not None:
            self._db = db
        else:
