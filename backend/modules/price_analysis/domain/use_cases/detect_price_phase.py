...
from backend.modules.price_analysis.domain.entities.price_models import EntryVerdict
...
class PricePhaseIntelligence:
    ...
    EXHAUSTION_ATR_DISTANCE = rules.EXHAUSTION_ATR_DISTANCE
    VCP_RANGE_CONTRACTION = rules.VCP_RANGE_CONTRACTION
    BREAKOUT_RVOL_MIN = rules.BREAKOUT_RVOL_MIN
    CORRECTION_RVOL_MAX = rules.CORRECTION_RVOL_MAX
