...
===================================================
Cross-cutting port for Smart Money Concepts structural analysis.
Provides BOS, CHoCH, Order Blocks, FVG, and liquidity sweep detection.

Relocated from simulation/domain/ports/ to shared/domain/ports/
because market structure analysis is used by both Entry Hubs (live)
and the Simulation PreTradeGate (backtesting).

Implementor: simulation/infrastructure/smc_adapter.py
"""
