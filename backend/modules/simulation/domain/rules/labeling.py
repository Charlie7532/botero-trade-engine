"""
Institutional Labeling — López de Prado (Ch. 3-4)
====================================================
Triple Barrier, Meta-Labeling, and Sample Weighting.

Migrated from _legacy/sequence_modeling.py into simulation domain rules.
These are pure domain logic (stdlib + pandas + numpy only).
"""
import pandas as pd
import numpy as np
import torch
