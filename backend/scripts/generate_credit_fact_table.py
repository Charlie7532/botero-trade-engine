...
def main():
    ...
    fact_store = {
        "_documentation": {
            ...
            "signal_interpretation_policy": "Pure domain adapters (CreditLookupAdapter, CreditSigmetService, MarketHealthIntelligence) interpret probabilities dynamically.",
