...
ROOT = Path(__file__).resolve().parents[3]  # backend/scripts/generators/ → repo root
...
def compute_cross_station_features(lake: pd.DataFrame, stations: list) -> pd.DataFrame:
    ...
    panic_conditions = {
        ...
        "skew_d1": {"INSURANCE_BID", "EXTREME_PEAK_INSURANCE"},
    ...
    euphoria_conditions = {
        ...
        "skew_d1": {"EXTREME_PUT_CAPITULATION", "PUT_CAPITULATION"},
