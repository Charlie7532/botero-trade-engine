...
# Save window data
df_win.to_parquet("/root/botero-trade/data/research/early_warning/early_warning_windows.parquet")
ep_agg.to_parquet("/root/botero-trade/data/research/early_warning/early_warning_episodes.parquet")
df_all.to_parquet("/root/botero-trade/data/research/early_warning/early_warning_all_pivots.parquet")
