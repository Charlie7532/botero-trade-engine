 ...
 * Email Constants
 *
 * Shared constants for email templates including brand colors,
 * social links, and configuration.
 * 
...
export const COLORS = {
    ...
    // Highlight section (same as primary for consistency)
    highlight: '#f5ff80',
...
// Social platform types matching SiteSettings
...
/**
 * Minimal Material Design inspired SVG icons for social platforms
 * These are simplified paths that work well in emails
 */
